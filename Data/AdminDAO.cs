...
namespace SchedulerApp.Data
{
    internal class AdminDAO
    {
        ...
        internal List<AdminModel> SearchForName(string searchPhrase)
        {
            List<AdminModel> returnList = new List<AdminModel>();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sqlQuery = "select * from dbo.ServiceDetail where LastName like @searchForMe";
        ...
        public int CreateOrUpdate(AdminModel adminModel)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                else
                {
                    ...
                    sqlQuery = "update dbo.ServiceDetail set FirstName = @FirstName, LastName = @LastName, Date = @Date, Duties = @Duties, Service = @Service, UserID = @UserID where Id = @Id";
                }
